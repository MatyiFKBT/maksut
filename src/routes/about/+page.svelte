...
<div class="max-w-[64rem] mx-auto p-4 flex flex-col gap-4">
  <h1 class="font-bold text-2xl">About</h1>

  <p>
    This is a <a href="https://kit.svelte.dev">SvelteKit</a> app. I created this
    for Hacktoberfest 2024 to learn more about SvelteKit, and to have a simple, web
    app to check my progress.
  </p>
